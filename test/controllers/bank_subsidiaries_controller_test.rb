...
class BankSubsidiariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bank_subsidiary" do
    assert_difference('BankSubsidiary.count') do
      post bank_subsidiaries_url, params: { bank_subsidiary: { addres: @bank_subsidiary.addres, bank_id: @bank_subsidiary.bank_id } }
    end
  ...
  test "should update bank_subsidiary" do
    patch bank_subsidiary_url(@bank_subsidiary), params: { bank_subsidiary: { addres: @bank_subsidiary.addres, bank_id: @bank_subsidiary.bank_id } }
