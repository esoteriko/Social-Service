...
class ObjectivesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create objective" do
    assert_difference('Objective.count') do
      post objectives_url, params: { objective: { description: @objective.description, period_value: @objective.period_value, time_id: @objective.time_id, user_id: @objective.user_id } }
    end
  ...
  test "should update objective" do
    patch objective_url(@objective), params: { objective: { description: @objective.description, period_value: @objective.period_value, time_id: @objective.time_id, user_id: @objective.user_id } }
